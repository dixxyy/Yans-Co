      ...
      <div class="row align-items-center">
        <div class="col-lg-6 text-white">
          <h1 class="display-3 fw-bold mb-4 animate-fade-in">
            Koleksi Tas Mewah <br>
            <span class="text-gradient">Autentik & Eksklusif</span>
          </h1>
          <p class="lead mb-4 text-white-50">Temukan berbagai pilihan tas premium dari brand mode ternama dunia untuk menyempurnakan gaya hidup elegan Anda</p>
        ...
        <div class="col-lg-6 d-none d-lg-block">
          <div class="hero-image-container">
            <img src="https://edit.voila.id/wp-content/uploads/2024/07/tiers-of-brand.jpg" class="img-fluid rounded-4 shadow-lg" alt="Luxury Fashion Catalog">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="products-section py-5" id="products">
    <div class="container">
      <div class="text-center mb-5">
        ...
        <p class="text-muted fs-5">Investasi gaya terbaik untuk melengkapi penampilan harian Anda</p>
      </div>
          ...
          <div class="contact-info-card p-4 h-100">
            <div class="d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <p class="text-muted mb-0">info@yansandco.com</p>
              </div>
            </div>
          </div>
        </div>
